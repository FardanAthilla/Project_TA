...
class AddSparepartService extends StatefulWidget {
  ...
  const AddSparepartService({Key? key, required this.itemSelectionServiceController})
      : super(key: key);
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Obx(() {
        return AnimatedSlide(
          ...
          offset: widget.itemSelectionServiceController.showBottomBarSparepartService.value
              ? Offset.zero
              : const Offset(0, 1),
          child: AnimatedOpacity(
            duration: const Duration(milliseconds: 300),
            opacity: widget.itemSelectionServiceController.showBottomBarSparepartService.value
                ? 1.0
                : 0.0,
            child: widget.itemSelectionServiceController.showBottomBarSparepartService.value
                ? BottomAppBar(
                    color: Colors.blue,
                    child: Row(
                      ...
                      children: [
                        Obx(() {
                          int totalItems = widget.itemSelectionServiceController
                              .selectedQuantitiesSparepartService.values
                                ...
                                for (var item
                                  ...
                                  if (widget.itemSelectionServiceController
                                    ...
                                    var selectedQuantity = widget
                                            ...
                                            .selectedQuantitiesSparepartService[
                                        item.sparepartItemsId]!;
                                    var selectedItemsSparepartService = SelectedItems(
                                    ...
                                    widget.itemSelectionServiceController
                                        .selectItemSparepartService(selectedItemsSparepartService);
                                    Get.back();
                                  }
                                }
                              },
